...
class Lexicon:
    ...
    def from_file(cls, file: Path) -> Lexicon:
        ...
        # FINISH THIS FUNCTION
        lexicon = Lexicon()
        #instantiating a Lexicon object
        word_to_index={}
        embeddings_list=[]
...
# Define Lexicon class and its from_file method here

# ...

# Your code snippet
from pathlib import Path
lexicon_object = Lexicon.from_file(Path("/Users/miltonlin/Documents/GitHub/NLP_2023/NLP_fall_2023/Week4/www.cs.jhu.edu/~jason/465/hw-lm/lexicons/words-50.txt"))

## NOw let us test the codde 

index1 = lexicon_object.word_to_index['the']
print(index1)
print(lexicon_object.embeddings[index1])